...
'''**********************************************************************************
                                                                                    *
Project Name: alliance_delegate_msg.py                                *
                                                                                    *
...
def main(tx_id, message_no, transaction_no, tx_type, message,  ids):
    ...
    try:
        ...
        query = """
        INSERT INTO alliance_delegate_msg (tx_id, tx_type, delegator_address_id, validator_address_id, tx_denom, amount, message_info, comment) VALUES (%s, %s, %s, %s, %s, %s,%s, %s);
        """
