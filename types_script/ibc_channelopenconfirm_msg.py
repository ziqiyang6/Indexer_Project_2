...
def main(tx_id, tx_type, message):
    ...
    try:
        ...
        query = """
                INSERT INTO ibc_channelopenconfirm_msg (tx_id, tx_type, port_id, channel_id, proof_acked, proof_height_revision_number, proof_height_revision_height, signer, message_info) 
        ...
        values = (tx_id, tx_type, port_id, channel_id, proof_ack, proof_height_revision_number, proof_height_revision_height, signer, message)
