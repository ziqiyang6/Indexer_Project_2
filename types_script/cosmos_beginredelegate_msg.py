...
def main(tx_id, tx_type, message, ids):
    ...
    try:
        ...
        query = """
        INSERT INTO cosmos_beginredelegate_msg (tx_id, tx_type, delegator_address_id, validator_src_address_id, validator_dst_address_id, tx_denom, amount, message_info) VALUES (%s, %s, %s, %s, %s, %s,%s,%s);
        """
