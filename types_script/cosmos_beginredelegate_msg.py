...
'''**********************************************************************************
                                                                                    *
Project Name: cosmos_beginredelegate_msg.py                                *
                                                                                    *
...
def main(tx_id, message_no, transaction_no, tx_type, message, ids):
    ...
    try:
        ...
        query = """
        INSERT INTO cosmos_beginredelegate_msg (tx_id, tx_type, delegator_address_id, validator_src_address_id, validator_dst_address_id, tx_denom, amount, message_info, comment) VALUES (%s, %s, %s, %s, %s, %s,%s,%s, %s);
        """
