...
def main(tx_id, tx_type, message, ids):
    ...
    try:
        ...
        query = """
        INSERT INTO cosmos_revoke_msg (tx_id, tx_type, send_address_id, receive_address_id, msg_type_url, message_info) VALUES (%s, %s, %s, %s, %s, %s);
        """

        values = (tx_id, tx_type, ids['granter_id'], ids['grantee_id'], msg_type_url, message)
