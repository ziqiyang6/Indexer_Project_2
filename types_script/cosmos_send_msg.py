...
def main(tx_id, tx_type, message, ids):
    ...
    try:
        ...
        query = """
        INSERT INTO cosmos_send_msg (tx_id, tx_type, from_address_id, to_address_id, tx_denom, amount, message_info) VALUES (%s, %s, %s, %s, %s, %s, %s);
        """

        values = (tx_id, tx_type, ids['from_address_id'], ids['to_address_id'], tx_denom, amount, message)
