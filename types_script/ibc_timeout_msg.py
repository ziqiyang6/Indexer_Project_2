...
def main(tx_id, message_no, transaction_no, tx_type, message):
    ...
    try:
        ...
        values = (tx_id, tx_type, sequence, source_port, source_channel, destination_port, destination_channel, data, timeout_height_revision_num, timeout_height_revision_height, timeout_timestamp, proof_unreceived, proof_height_revision_number, proof_height_revision_height, next_sequence_recv, signer, message, comment)
