...
'''**********************************************************************************
                                                                                    *
Project Name: alliance_claimdelegationrewards_msg.py                                *
                                                                                    *
...
def main(tx_id, num, tx_type, message, ids):
    ...
    try:
        ...
        query = """
        INSERT INTO alliance_claimdelegationrewards_msg (tx_id, tx_type, delegator_address_id, validator_address_id, tx_denom, message_info, comment) VALUES (%s, %s, %s, %s, %s,%s,%s);
        """

        values = (tx_id, tx_type, ids['delegator_address_id'], ids['validator_address_id'], tx_denom, message, comment)
